...
* **Adição de novos componentes de UI**:
  * Criar novos componentes de interface do usuário que melhorem a experiência do usuário, como menus, botões ou modais.
...
`emoji categoria(tipo): titulo do commit.`
