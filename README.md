...
| `:x:` | :x: | Failed tests. | Teste reprovados. |
...
| `:green_book:` | :green_book: | Add app documentation. | Adicionar documentação do aplicativo. |
| `:orange_book:` | :orange_book: | Add API documentation.| Adicionar documentação da API. |
...
| CODE | EMOJI | DESCRIPTION | TRANSLATION |
| :--- | :---: | :---------- | :---------- |
| `:chart_with_downwards_trend:` | :chart_with_downwards_trend: | Optimize code for performance. | Otimizar código para desempenho. |
...
| CODE | EMOJI | DESCRIPTION | TRANSLATION |
| :--- | :---: | :---------- | :---------- |
| `:adhesive_bandage:` | :adhesive_bandage: | Apply a temporary fix. | Aplicar uma correção temporária. |
| `:fire_engine:` | :fire_engine: | Apply emergency fix. | Aplicar correção de emergência. |
